...
if __name__ == "__main__":
    mutation_report_file1 = './Tests_No_Comments/ch03/MutationsCh03/mutation_unique.txt'
    code_file1 = './ch03/No_Comments/unique.py'
    dir_path1 = './Tests_No_Comments/Ch03/MutationsCh03/unique'
